...
def cmd_close_issue(gh: GitHub, issue: int, repo_path: Optional[str] = None,
    ...
    apply the terminal fields, release its worktree and delete a merged design PR's branch
    (`design_pr_branch`, non-fatal) -- for a unit that never merges through `merge-pr`.
    Counts toward the run cap."""
